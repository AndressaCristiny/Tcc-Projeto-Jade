    ...
    <nav class="navbar navbar-dark bg-dark navbar sticky-top bg-light">
      <div class="dropdown">
        ...
        <ul class="nav nav-tabs justify-content-center" style="background-color: #bddec4;">
          <li class="nav-item">
            <a class="nav-link" href="Aluno Inicio.php" style="color: black;">Salas</a>
          </li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <li class="nav-item">
...
<br><br>
    ...
    while($row = mysqli_fetch_array($resul)){
        $table .= "<tr>";
        $table .= "<td><a href='{$row['endereco']}'>{$row['Nome_arquivos']}</a></td>";
        $table .= "</tr>";
    }
    ...
    ?>
        ...
        <div class="card text-center" style="max-width: 300px; height: 400px;" id="cardd" >
          <div class="card-body">
 ...
 <div class="card text-center" style="width: 40%; max-height: 670px;" id="cardd">
          <div class="card-body">
            <div class="card-header">
